...
#else
#    if __GNUC__ >= 4
#        define CHK_COMMON_HELPER_DLL_IMPORT __attribute__((visibility("default")))
#        define CHK_COMMON_HELPER_DLL_EXPORT __attribute__((visibility("default")))
#        define CHK_COMMON_HELPER_DLL_LOCAL  __attribute__((visibility("hidden")))
#    else
